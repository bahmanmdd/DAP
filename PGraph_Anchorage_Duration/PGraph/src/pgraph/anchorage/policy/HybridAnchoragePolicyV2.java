 ...
 */
public class HybridAnchoragePolicyV2 implements AnchorPolicy {
    ...
    public HybridAnchoragePolicyV2(double maximumDistance) {
        this.maximumDistance = maximumDistance;
    }

    public HybridAnchoragePolicyV2(double w_HOLEDEGREE, double w_SAFETY, double w_DISTANCE, double w_STACKING, double maximumDistance) {
