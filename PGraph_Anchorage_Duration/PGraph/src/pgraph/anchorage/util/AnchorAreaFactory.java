 ...
 */
public class AnchorAreaFactory {

    public static List<AnchorArea> createExperimentAreaSet()
    {
        List<AnchorArea> areaList = new ArrayList<AnchorArea>();
    ...
    public static AnchorArea createDemoArea() // RECTANGLE 1000-1000
    {
    ...
    public static AnchorArea createTypeA() // RECTANGLE 5000-3000
    {
        AnchorArea aa = new AnchorArea();
    ...
    public static AnchorArea createTypeB() // IMKIZKENAR YAMUK 7000-4000
    {
        AnchorArea aa = new AnchorArea();
    ...
    public static AnchorArea createTypeC() // TERS IMKIZKENAR YAMUK 7000-4000
    {
        AnchorArea aa = new AnchorArea();
    ...
    public static AnchorArea createTypeD() // Kum saati  6000-8000
    {
        AnchorArea aa = new AnchorArea();
    ...
    public static AnchorArea createNonUniform1() // Non Uniform Area
    {
    ...
    public static AnchorArea createNonUniform2() // Non Uniform Area
    {
    ...
    public static AnchorArea createNonUniform_AK1() // Non Uniform Area
    {
    ...
    public static AnchorArea createNonUniform_AK2() // Non Uniform Area
    {
    ...
    public static AnchorArea createNonUniform_AK3() // Non Uniform Area
    {
