...
public class BaseGraphPanel extends JComponent
        implements MouseListener, MouseMotionListener, MouseWheelListener  , GraphPanel,KeyListener
{
    private Renderable content=null;
    ...
    public BaseGraphPanel(Renderable content) {

        this.content = content;
        setPreferredSize(new Dimension(480, 480));
        setSize(getPreferredSize());
        setViewRegion(-10 , 10 , -10, 10);

        BaseRenderer br = new BaseRenderer(content);
        setRenderable(br);
    ...
    public void setViewRegion(double minX, double maxX, double minY, double maxY) {
        ...
        double scaleY = (maxY - minY) / getHeight();
