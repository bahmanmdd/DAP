...
public class RandUtil extends java.util.Random {
  ...
  /* From Numerical "Recipes in C", page 292 */
    ...
    public static RandUtil instance = new RandUtil((int) System.currentTimeMillis());

    public static void resetInstance()
    {
        instance = new RandUtil((int) System.currentTimeMillis());
    }

    public static Color randomColor(int colorIndex) {
        int c = (colorIndex <0) ?  instance.nextInt(9):(colorIndex%9);
        switch (c)
        {
