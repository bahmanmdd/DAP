 ...
 */
public class DiskObstacleShape implements ObstacleShape{
    ...
    public DiskObstacleShape() {
    }

    public DiskObstacleShape(Point2D.Double center, double radius) {
        this.center = center;
        this.radius = radius;
    }
    ...
    public String toString() {
        return "pgraph.DiskObstacleShape "+ center.getX()+" "+center.getY()+" " + radius ;  //To change body of implemented methods use File | Settings | File Templates.
    }
    ...
    public boolean intersectsLine(Point2D.Double p1, Point2D.Double p2)
    {
        ...
        double d = (double) l.ptSegDist(center.getX(),center.getY());
    ...
    public double[][] getTangentsTo(DiskObstacleShape d)
    {
        return ArcMath.getTangents(center.getX(),center.getY(),radius,d.center.getX(),d.center.getY(),d.radius);
    }
    ...
    public int lineIntersectionCount(LineEdge le) throws InstantiationException {
        return le.intersectionCount(shape());
    }
}
