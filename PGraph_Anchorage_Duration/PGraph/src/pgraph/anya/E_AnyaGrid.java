 ...
 */
public class E_AnyaGrid extends BaseDirectedGraph implements MBRunnable
{
     ...
     * @throws java.io.IOException
     */
    public E_AnyaGrid(String fileName) throws NumberFormatException, InstantiationException, IllegalAccessException, ClassNotFoundException, IOException
    {
        load(fileName);
     ...
     * @param tY
     */
    public E_AnyaGrid(int x, int y, double el, Point2D.Double offset, int sX, int sY, int tX, int tY)
	{
        xSize = x;
		ySize = y;
		unitEdgeLen = el;
     ...
     * @throws InstantiationException
     */
    public E_AnyaGrid cloneGraphWithoutObstacles()  throws InstantiationException
    {
        E_AnyaGrid g = new E_AnyaGrid( xSize, ySize, unitEdgeLen, offSet, start.gridPos.getX(),start.gridPos.getY(),end.gridPos.getX(),end.gridPos.getY());
        return g;
    }
...
/*    public static void test2()
    {
        E_AnyaGrid ag = new E_AnyaGrid(200,200,1,new Point2D.Double(0,0),5,0,197,199);
