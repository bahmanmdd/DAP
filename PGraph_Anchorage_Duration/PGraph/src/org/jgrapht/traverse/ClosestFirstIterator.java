        ...
        E, FibonacciHeapNode<ClosestFirstIterator.QueueEntry<V, E>>>
{
     ...
     */
    public ClosestFirstIterator(Graph<V, E> g, V startVertex, V endVertex)
    {
     ...
     * unbounded search.
     */
    public ClosestFirstIterator(Graph<V, E> g, V startVertex, V endVertex, double radius)
    {
        super(g, startVertex);
        this.radius = radius;
    ...
    protected void encounterVertexAgain(V vertex, E edge)
    {
        ...
        double heuristicDistToEndVertex = 0.0; //VA changed
