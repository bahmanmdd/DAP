...
public class FibonacciHeapNode<T>
{
    ...
    double key;
    double secondaryKey;
    final long BIG_ONE = 100000;
    final double epsilon = 1/BIG_ONE;
    ...
    {
        long tmpKey = (long)(this.key * this.BIG_ONE + 0.5);
        long tmpOther = (long)(other.key * this.BIG_ONE + 0.5);
        if(tmpKey < tmpOther)
        {
            return true;
        }
        ...
        if(tmpKey == tmpOther)
        {
            tmpKey = (long)(this.secondaryKey * BIG_ONE + 0.5);
            tmpOther = (long)(other.secondaryKey * BIG_ONE + 0.5);
            if(tmpKey > tmpOther)
            {
                return true;
            }
